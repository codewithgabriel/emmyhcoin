      ...
      <div className="services-wrapper container-fluid row col-12">
        ...
        <div data-aos="fade-up" className="service-card col-lg-4 col-md-4 col-sm-4 col-xm-12">
          ...
          <div className="service-card-text">
            ...
            <p>
            We now confident that our customers would whole-heartedly recommend us, we still want to express out gratitude by rewarding you for doing so! By sharing your referral links, you'll receive a lifetime commission every time anyone you refer completes an order with us. 
            </p>
          </div>
        </div>
